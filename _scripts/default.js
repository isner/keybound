$(document).ready(function() {
	...
	$('#sb_prevPage').mouseenter(function() {
		$(this).find('img').attr('src', '_images/sb_arrow_left_hover.png');
	}).mouseleave(function() {
		$(this).find('img').attr('src', '_images/sb_arrow_left.png');
	});
	
	$('#sb_nextPage').mouseenter(function() {
		$(this).find('img').attr('src', '_images/sb_arrow_right_hover.png');
	}).mouseleave(function() {
		$(this).find('img').attr('src', '_images/sb_arrow_right.png');
	});
	...
	// If the current URL contains a hash property
		...
		// For each 4-digit code
			...
			// This code position IS NOT blank
				...
				var importedIcon = '<div class="draggableAbility ui-draggable roaming" style="left: 0px; top: 0px; height: 30px; width: 30px; border: 1px solid rgb(122, 122, 122); opacity: 1; position: relative;"><a rel name="'+name+'" class="'+hashCode_array[i]+'"><img src="_images/_'+src+'.jpg"></a></div>';
